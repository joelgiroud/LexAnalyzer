...
${OBJECTDIR}/_ext/5c0/lex.yy.o: ../lex.yy.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5c0/lex.yy.o ../lex.yy.c

${OBJECTDIR}/_ext/5c0/principal.o: ../principal.c
	${MKDIR} -p ${OBJECTDIR}/_ext/5c0
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5c0/principal.o ../principal.c

${OBJECTDIR}/_ext/5c0/prueba.o: ../prueba.c
	${MKDIR} -p ${OBJECTDIR}/_ext/5c0
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5c0/prueba.o ../prueba.c
